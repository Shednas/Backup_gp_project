                ...
                <tbody>
                    <?php foreach ($announcements as $announcement): ?>
                        <tr>
                            ...
                            <td>
                                <form method="POST" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to delete this announcement?')">
                    ...
                    <?php foreach ($assignments as $assignment): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                                <form method="POST" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to delete this assignment? This will also delete all related submissions and grades.')">
                            ...
                            <div style="display: flex; gap: 15px; align-items: end;">
                                ...
                                <div style="flex: 2;">
                                    ...
                                    <textarea name="feedback" rows="2" 
                                            style="width: 90%; margin-left:30px; padding: 8px; border: 1px solid #dee2e6; border-radius: 4px; resize: vertical;"
