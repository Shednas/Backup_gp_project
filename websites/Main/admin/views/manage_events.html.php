    ...
    <div class="form-section">
        ...
        <form method="POST" class="admin-form">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="event_date">Event Date *</label>
                        <input type="date" id="event_date" name="event_date" class="form-control" required value="<?php echo $edit_event ? htmlspecialchars($edit_event['event_date']) : ''; ?>">
                </div>
                
                <div class="form-group">
                    <label for="event_time">Event Time *</label>
                        <input type="time" id="event_time" name="event_time" class="form-control" required value="<?php echo $edit_event ? htmlspecialchars($edit_event['event_time']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="max_participants">Max Participants</label>
                        <input type="number" id="max_participants" name="max_participants" class="form-control" min="1" placeholder="Leave empty for unlimited" value="<?php echo ($edit_event && $edit_event['max_participants'] !== null) ? htmlspecialchars((string)$edit_event['max_participants']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <?php if ($edit_event): ?>
                    <a href="index.php?page=manage_events" class="btn btn-secondary">❌ Cancel</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="index.php?page=manage_events&edit=<?php echo $event['id']; ?>" 
