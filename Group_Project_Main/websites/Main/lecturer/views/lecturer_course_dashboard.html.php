...
<div class="lecturer-management">
    ...
    <nav class="course-nav">
        <a href="index.php?page=course_dashboard&section=manage_content&id=<?= urlencode($course_id); ?>"
        class="course-nav-item <?= $current_section === 'manage_content' ? 'active' : '' ?>">
            📚 Manage Content
        </a>

        <a href="index.php?page=course_dashboard&section=manage_announcement&id=<?= urlencode($course_id); ?>"
        class="course-nav-item <?= $current_section === 'manage_announcement' ? 'active' : '' ?>">
            📢 Manage Announcements
        </a>

        <a href="index.php?page=course_dashboard&section=manage_assignment&id=<?= urlencode($course_id); ?>"
        class="course-nav-item <?= $current_section === 'manage_assignment' ? 'active' : '' ?>">
            📝 Manage Assignments
        </a>

        <a href="index.php?page=course_dashboard&section=manage_submissions&id=<?= urlencode($course_id); ?>"
        class="course-nav-item <?= $current_section === 'manage_submissions' ? 'active' : '' ?>">
            📤 Manage Submissions
        </a>
    </nav>
    ...
    <div class="course-content">
        ...
        <?php if ($current_section === 'manage_content'): ?>
            <h2 class="section-title">📚 Manage Course Content</h2>
                    ...
                    <tbody>
                        <?php foreach ($materials as $material): ?>
                            <tr>
                                ...
                                <td><a href="<?php echo htmlspecialchars($material['file_path']); ?>" target="_blank">📁 Download</a></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($assignment['file_path']): ?>
                                        <a href="<?php echo htmlspecialchars($assignment['file_path']); ?>" target="_blank" class="btn btn-primary" style="margin-right: 5px;">View File</a>
                                    <?php endif; ?>
        ...
        <?php elseif ($current_section === 'manage_submissions'): ?>
            <h2 class="section-title">📤 Manage Submissions</h2>
