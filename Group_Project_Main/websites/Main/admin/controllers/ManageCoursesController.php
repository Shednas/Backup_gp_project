...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // You can move detailed logic for add/update/delete into separate functions to keep this clean
    // For simplicity, keep here but minimal and focused
    ...
    if (isset($_POST['add_course'])) {
        ...
        if ($course_code && $title && $lecturer && $credits && $term) {
            // Handle file uploads (simplified - add security as needed)
